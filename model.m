...
[Xtest, mu, sigma] = NormalizeFea(Xtest);

[X_norm, mu, sigma] = NormalizeFea(X);
...
% figure;
% plot(falseneg, truepos, 'linewidth', 3, 'marker', 'o', 'markersize',10,'markeredgecolor', 'k', 'markerfacecolor', 'g');